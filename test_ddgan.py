...
def sample_and_test(args):
    ...
    result_folder = result_dir + f'/{args.version}'
    save_dir += f'/{args.version}'
    result_dir += f'/{args.version}/netG_{args.epoch_id}.pth'
    ...
    if args.compute_fid:
        ...
        json_filename = f'{result_folder}/epoch_{args.epoch_id}_output.json'
