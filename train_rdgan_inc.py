...
def train(rank, gpu, args):
    ...
    if args.dataset in ['cifar10', 'mnist', 'stackmnist', 'stl10', 'celeba_256', 'clipart_64', 'quickdraw_64', 'sketch_64', 'isolation_forest_celeba_5p_fashion', 'mnist_1c', 'fashion_mnist_1c', 'mnist_cifar10', 'mnist12', 'mnist021']:
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        for iteration, (x, y) in enumerate(tqdm(data_loader)):
            ...
            # ipdb.set_trace()
            tau = (t + 1) * 0.0005
            errD_fake = phi_star1(output - tau * torch.sum(((x_0_predict-x_tp1.detach()).view(x_tp1.detach().size(0), -1))**2, dim=1))
            ...
            tau = (t + 1) * 0.0005
            errG = tau * torch.sum(((x_0_predict-x_tp1.detach()).view(x_tp1.detach().size(0), -1))**2, dim=1) - output
