...
def sample_and_test(args, epoch_id):
    ...
    samples_folder = samples_dir + f'/{args.version}/{args.epoch_start}'
    result_folder = result_dir + f'/{args.version}/fid'
...
if __name__ == '__main__':
    ...
    for epoch_id in range(args.epoch_start, args.epoch_start + 1, args.epoch_jump):
