...
from util.utility import copy_source, broadcast_params, q_sample_pairs, sample_posterior, sample_from_model
...
def train(rank, gpu, args):
    ...
    if args.dataset in ['cifar10', 'mnist', 'stackmnist', 'stl', 'celeba_256', 'clipart_64', 'quickdraw_64', 'sketch_64', 'isolation_forest_celeba_5p_fashion', 'mnist_1c', 'fashion_mnist_1c', 'mnist_cifar10', 'mnist12']:
